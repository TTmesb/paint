 ...
 */
public class magnusexempel extends Canvas implements Runnable{
    ...
    public static void main(String[] args) {
        magnusexempel painting = new magnusexempel();
        painting.start();
    }
    ...
    private class ML implements MouseListener {
        ...
        public void mouseClicked(MouseEvent mouseEvent) {
            int tx = MouseInfo.getPointerInfo().getLocation().x;
            int ty = MouseInfo.getPointerInfo().getLocation().y;
            drawTree(g,tx,ty );
